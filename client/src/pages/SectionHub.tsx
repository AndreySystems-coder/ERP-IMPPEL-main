    ...
    <HubPage
      config={{
        ...
        items: [
          ...
          { title: "Status de Orçamentos", description: "Etapas e mensagens automáticas dos orçamentos.", href: "/status-personalizados", icon: Hash, permission: "viewStatusSettings", accent: accents.blue },
          { title: "Status de Obras", description: "Etapas e mensagens automáticas das ordens de serviço.", href: "/status-obras", icon: Hash, permission: "viewStatusSettings", accent: accents.blue },
          { title: "Governança Comercial", description: "Alçadas, descontos, comissões, logística e aditivos.", href: "/governanca-comercial", icon: Scale, permission: "viewSettings", accent: accents.violet },
