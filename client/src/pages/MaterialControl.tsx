...
import { AlertTriangle, ArrowDownCircle, ArrowUpCircle, ClipboardList, History, Package, Users } from "lucide-react";
      ...
      <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-gray-500">Saídas, devoluções e responsabilidade por material</p>
          </div>
        </div>

        <div className="grid grid-cols-3 gap-3 text-center sm:flex sm:items-center sm:gap-5">
          <div>
