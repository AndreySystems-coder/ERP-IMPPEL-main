...
Nao foi criada integracao falsa. O ERP permanece com fluxo manual/WhatsApp ja existente. Integracao real com Waseller depende de credenciais e contrato de API.
