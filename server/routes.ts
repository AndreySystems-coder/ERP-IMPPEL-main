...
export async function registerRoutes(
  ...
  // supervisão e campos de RH em users). Roda ANTES do deploy do código que usa essas
  // colunas/tabelas, exatamente para evitar o app quebrar por coluna/tabela inexistente.
