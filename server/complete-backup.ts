...
export const TECHNICAL_BACKUP_TYPES: Record<string, { module: CompleteBackupModule; tables: string[]; label: string }> = {
  ...
  materiais: { module: "controleMateriais", tables: ["materialWithdrawals", "materialWithdrawalItems", "obraConsumoLogs", "salaryDiscounts", "materialCustodyTransfers", "materialResponsibilityCases", "materialKits", "materialKitItems", "toolMaintenanceRecords", "materialCountAudits", "materialTrainingGuides"], label: "Materiais" },
...
const RELATIONSHIPS: Record<string, Array<{ field: string; target: string }>> = {
  ...
  materialCustodyTransfers: [{ field: "withdrawalId", target: "materialWithdrawals" }, { field: "withdrawalItemId", target: "materialWithdrawalItems" }, { field: "inventoryId", target: "inventory" }, { field: "previousUserId", target: "users" }, { field: "newUserId", target: "users" }, { field: "workOrderId", target: "workOrders" }],
  materialResponsibilityCases: [{ field: "withdrawalId", target: "materialWithdrawals" }, { field: "withdrawalItemId", target: "materialWithdrawalItems" }, { field: "inventoryId", target: "inventory" }, { field: "workOrderId", target: "workOrders" }, { field: "jobId", target: "jobs" }, { field: "userId", target: "users" }],
  materialKits: [{ field: "assignedUserId", target: "users" }],
  materialKitItems: [{ field: "kitId", target: "materialKits" }, { field: "inventoryId", target: "inventory" }],
  toolMaintenanceRecords: [{ field: "inventoryId", target: "inventory" }, { field: "withdrawalId", target: "materialWithdrawals" }],
  materialCountAudits: [{ field: "inventoryId", target: "inventory" }],
