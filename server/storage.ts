...
export const COMPLETE_BACKUP_MODULE_TABLES = {
  ...
  controleMateriais: ["materialWithdrawals", "materialWithdrawalItems", "obraConsumoLogs", "salaryDiscounts", "materialCustodyTransfers", "materialResponsibilityCases", "materialKits", "materialKitItems", "toolMaintenanceRecords", "materialCountAudits", "materialTrainingGuides"],
...
const COMPLETE_TABLES: Record<string, { table: any; dbName: string }> = {
  ...
  materialCustodyTransfers: { table: materialCustodyTransfers, dbName: "material_custody_transfers" },
  materialResponsibilityCases: { table: materialResponsibilityCases, dbName: "material_responsibility_cases" },
  materialKits: { table: materialKits, dbName: "material_kits" },
  materialKitItems: { table: materialKitItems, dbName: "material_kit_items" },
  toolMaintenanceRecords: { table: toolMaintenanceRecords, dbName: "tool_maintenance_records" },
  materialCountAudits: { table: materialCountAudits, dbName: "material_count_audits" },
  materialTrainingGuides: { table: materialTrainingGuides, dbName: "material_training_guides" },
...
export function createMemoryStorage(): IStorage {
  ...
  const tableMap: Record<string, string> = {
    ...
    MaterialCustodyTransfer: "materialCustodyTransfers",
    MaterialCustodyTransfers: "materialCustodyTransfers",
    MaterialResponsibilityCase: "materialResponsibilityCases",
    MaterialResponsibilityCases: "materialResponsibilityCases",
    MaterialKit: "materialKits",
    MaterialKits: "materialKits",
    MaterialKitItem: "materialKitItems",
    MaterialKitItems: "materialKitItems",
    ToolMaintenanceRecord: "toolMaintenanceRecords",
    ToolMaintenanceRecords: "toolMaintenanceRecords",
    MaterialCountAudit: "materialCountAudits",
    MaterialCountAudits: "materialCountAudits",
    MaterialTrainingGuide: "materialTrainingGuides",
    MaterialTrainingGuides: "materialTrainingGuides",
